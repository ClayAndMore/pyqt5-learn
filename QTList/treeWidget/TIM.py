...
class TIM(QWidget, Ui_Form):
    ...
    def creategroup(self, groupname):
        ...
        for name in ["上证指数", "深证指数", "创业版指"]:
            child = QTreeWidgetItem()
            font, up = self.create_stock()
            ...
            if up > 0:
                ...
                child.setToolTip(0, '涨')
            elif up < 0:
                child.setForeground(0, QBrush(Qt.green))
                child.setToolTip(0, '跌')
            elif up == 0:
